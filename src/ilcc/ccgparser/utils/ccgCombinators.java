...
public class ccgCombinators {
    ...
    public enum RuleType {
        fa, ba, fc, bc, bx, gfc, gbc, gbx, tfc, lp, rp, conj, conjF, lpconj, rpconj, tr, lexicon, lex, lreveal, rreveal, other, frag;
    }    
    ...
    public static CCGJRuleInfo checkCCGRules(CCGcat lcat, CCGcat rcat){
        CCGcat rescat;
        CCGJRuleInfo info = null;

        for(RuleType rule : ccgRules){
            if((rescat = checkRule(lcat, rcat, rule)) != null){                
                info = new CCGJRuleInfo(lcat, rcat, rescat, true, rule, 0, 0);
                break;
            }
        }
