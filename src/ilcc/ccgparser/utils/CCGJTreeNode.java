...
public abstract class CCGJTreeNode {
    ...
    private CCGJTreeNode(CCGcat ccgCat, ArcJAction ajact, RuleType rtype, int headId, SCoNLLNode headNode, HashMap depMap) {
        this.ccgCat = ccgCat;
        this.headDir = headId;
    ...
    static class CCGJTreeNodeBinary extends CCGJTreeNode {
        ...
        private CCGJTreeNodeBinary(CCGcat ccgCat, int headId, SCoNLLNode headNode, ArcJAction ajact,
                RuleType ruleType, boolean headIsLeft, CCGJTreeNode leftChild, CCGJTreeNode rightChild, HashMap depMap) {
            super(ccgCat, ajact, ruleType, headId, headNode, depMap);
        ...
        public CCGJTreeNode copy(){
            return new CCGJTreeNodeBinary(this.getCCGcat().copy(), this.getHeadDir(), this.getConllNode(), this.getArcAction(), this.getRuleType(), this.headIsLeft, this.getLeftChild(), this.getRightChild(), this.getDeps());
        }
    }
    ...
    static class CCGJTreeNodeLeaf extends CCGJTreeNode {
        private CCGJTreeNodeLeaf(CCGcat ccgCat, int headId, SCoNLLNode headNode, HashMap depMap) {
            super(ccgCat, null, RuleType.lexicon, headId, headNode, depMap);
        }
    ...
    static class CCGJTreeNodeUnary extends CCGJTreeNode {
        ...
        private CCGJTreeNodeUnary(CCGcat ccgCat, ArcJAction ajact, RuleType rtype, int headId, SCoNLLNode headNode, CCGJTreeNode child, HashMap depMap) {
            super(ccgCat, ajact, rtype, headId, headNode, depMap);            
            this.child = child;
        }
        ...
        @Override
        public CCGJTreeNode copy() {
            return new CCGJTreeNodeUnary(this.getCCGcat().copy(), this.getArcAction(), this.getRuleType(), this.getHeadDir(), this.getConllNode(), this.getLeftChild(), this.getDeps());
        }
    }
    
    public static CCGJTreeNode makeBinary(CCGcat ccgCat, ArcJAction ajact, RuleType ruleType, boolean headIsLeft, CCGJTreeNode left, CCGJTreeNode right){
        ...
        CCGJTreeNode result = new CCGJTreeNodeBinary(ccgCat, headid, headcNode, 
                ajact, ruleType, headIsLeft, left, right, depMap);
        
        return result;
    }
    
    public static CCGJTreeNode makeUnary(CCGcat ccgCat, ArcJAction ajact, RuleType ruleType, CCGJTreeNode child) {
        int headid;
        SCoNLLNode headcNode = child.getConllNode();
        headid = 0;
        HashMap<String, String> depMap = updateUnaryDeps(child, ccgCat);
        return new CCGJTreeNodeUnary(ccgCat, ajact, ruleType, headid, headcNode, child, depMap);
    }
